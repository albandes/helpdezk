...
EOF;
	...
	switch ($errorNumber )
	{
		...
		case 1 :	// Custom error.
			...
			break ;
		case 201 :
			$msg = 'Um arquivo com o mesmo nome já esta disponível. O arquivo carregado sera renomeado para "' . $fileName . '"' ;
			break ;
		case 202 :
			$msg = 'Arquivo Inválido' ;
			break ;
		default :
			$msg = 'Erro ao carregar arquivo. Erro número: ' + $errorNumber ;
			break ;
	}
