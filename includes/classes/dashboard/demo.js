...
$(function() {
  ...
  var options = {
    ...
    ajaxCallbacks: {
      ...
      getWidgetsByColumn: {  
        url: 'ajaxData/operation/get_widgets_by_column'
      },
      ...
      getWidget: {
        url: 'ajaxData/operation/get_widget'
      },
      ...
      saveColumns: {
        url: 'ajaxData/operation/save_columns'
      },
      ...
      widgetSettings: {
        url: 'ajaxData/operation/widget_settings'
      }
    },
