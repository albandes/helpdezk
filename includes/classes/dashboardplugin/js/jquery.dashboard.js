...
(function($) { // Create closure.
  ...
  $.fn.dashboard = function(options) {
    ...
    dashboard.setLayout = function(layout) {
      ...
      $('.' + opts.columnClass).sortable({
        ...
        receive: function(event, ui) {
          ...
          dashboard.element.trigger("dashboardStateChange",{"stateChange":"widgetAdded, widgetMoved, titleChanged, widgetClosed, metadataChanged, widgetRemoved","widget":w});
    ...
    dashboard.addWidget = function(obj, column) {
      ...
      dashboard.widgets[wid].element.trigger("widgetAdded,  widgetMoved, titleChanged, widgetClosed, metadataChanged, widgetRemoved", {"widget":dashboard.widgets[wid]});

      if (dashboard.initialized) {
        dashboard.log('dashboardStateChange event thrown for widget ' + wid,2);
        dashboard.element.trigger("dashboardStateChange",{"stateChange":"widgetAdded,  widgetMoved, titleChanged, widgetClosed, metadataChanged, widgetRemoved","widget":wi});
      }
    }
    ...
    function widget(widget) {
      ...
      widget.setTitle = function(newTitle){
        ...
        if (dashboard.initialized) {
          ...
          dashboard.element.trigger("dashboardStateChange",{"stateChange":"widgetAdded,  widgetMoved, titleChanged, widgetClosed, metadataChanged, widgetRemoved","widget":widget});
        }
      }
