...
class appServices
{
    ...
    /**
     * en_us Converts hexdec color string to rgb(a) string
     * pt_br Converte string de cor hexdec em string rgb(a)
     *
     * @param  mixed $color
     * @param  mixed $opacity
     * @return void
     ...
     * _formatBody
     * 
     * en_us Format the body of the email
     * pt_br Formata o corpo do e-mail
     *
     * @param  mixed $body
     * @return void
     */
    ...
    /**
     * _numberToWordsPortuguese
     * 
     * en_us Converts number to Portuguese text.
     * pt_br Converte o número em texto do português.
     *
     * @param  mixed $number
     * @param  mixed $feminine
     * @return void
     */
    function _numberToWordsPortuguese($number, $feminine = false) {
        $units = [
            0 => "zero", 1 => $feminine ? "uma" : "um", 2 => $feminine ? "duas" : "dois", 3 => "três", 4 => "quatro",
