        ...
        <div class="wrapper wrapper-content  ">
            ...
            <div class="row wrapper    white-bg ">
                <div class="col-sm-4">
                    ...
                    <h4>Cadastros / Atleta / <strong>Novo</strong></h4>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-atleta-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="apelido" name="apelido" class="form-control input-sm" required placeholder="{$plh_apelido}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="nome" name="nome" class="form-control input-sm" required placeholder="{$plh_nome}" >
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text"  id="cpf" class="form-control input-sm" placeholder="{$plh_cpf}" />
                            </div>
                            <label class="col-sm-1 control-label">Nascimento:</label>
                            <div class="col-sm-2">
                                <input type="text" id="dtnasc" name="dtnasc" class="form-control input-sm" placeholder="{$plh_dtnasc}" />
                            </div>
                            <label class="col-sm-1 control-label">Email:</label>
                            <div class="col-sm-2">
                                <input type="text" id="email" name="email" class="form-control input-sm"  placeholder="{$plh_email}" />
                            </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input type="text" id="telefone" class="form-control input-sm" data-mask="(99) 999999999" placeholder="{$plh_telefone}" />
                            </div>

                            <label class="col-sm-1 control-label">Celular:</label>
                            <div class="col-sm-2">
                                <input type="text" id="celular" name="celular" class="form-control input-sm" placeholder="{$plh_celular}"  required/>
                            </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div id="alert-create-atleta"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnCreateAtleta" >
            ...
            <div>
                ...
                {include file='modals/cadastroatleta/modal-alert-create.tpl'}
