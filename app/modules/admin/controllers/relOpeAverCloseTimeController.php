<?php
class relOpeAverCloseTime extends Controllers {
    ...
    public function index() {
		...
		$program = $bd->selectProgramIDByController("relOpeAverCloseTime/");
        ...
        $smarty->display('relOpeAverCloseTime.tpl.html');
    }
	...
	public function table_json() {
		...
		$pipe = new pipegrep();
		$db = new relOpeAverCloseTime_model();     
