<?php
class relRequestsGroup extends Controllers {
    ...
    public function index() {
		...
		$program = $bd->selectProgramIDByController("relRequestsGroup/");
		...
		$campos = '';
        $valores = '';					
        $smarty->display('relRequestsGroup.tpl.html');
    }
