        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.Holidays} / <strong>{$smarty.config.Holiday_import}</strong></h4>
                    </div>
                </div>
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="import-holiday-form">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-10 b-l">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.Previous_year}:</label>
                                <div class="col-sm-5">
                                    <select class="form-control input-sm" id="lastyear" name="lastyear" >
                                        <option value="X">&nbsp;</option>
                                        {html_options values=$lastyearids output=$lastyearvals selected=$idlastyear}
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="boxResult" class="row wrapper white-bg  text-center hide">
                        <div class="col-sm-12 b-l">
                            <h4>{$smarty.config.Holidays}</h4>                    
                        </div>

                        <div class="col-sm-12 b-l">
                            <p>{$smarty.config.Total_holidays} <span class="txtYear"><!-- --></span>: <strong class="txtCount"><!-- --></strong></p>                    
                        </div>
                        ...
                        <div class="col-sm-12 b-l">
                            <table id="holiday-table" class="table table-hover">
                                <thead>
                                    <tr>
                                        <th class="col-sm-2 text-center"><h4><strong>{$smarty.config.Date}</strong></h4></th>
                                        <th class="col-sm-4 text-center"><h4><strong>{$smarty.config.Description}</strong></h4></th>
                    ...
                    <div class="row wrapper  white-bg lineResult hide">
                        <div class="col-sm-2 b-l">                    
                        </div>

                        <div class="col-sm-10 b-l">
                            <div  class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.Import_to}:</label>
                                <div class="col-sm-5">
                                    <select class="form-control input-sm" id="nextyear" name="nextyear" >
                                    </select>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div id="alert-import-holiday"></div>
                        </div>
                    </div>
                    ...
                    <div class="row wrapper white-bg text-center">
                        <div class="col-sm-12 form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnImportHoliday" >
                                <span class="fa fa-download"></span>  &nbsp;{$smarty.config.Import}
                            </button>
                        </div>
                    </div>
