...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/admin/views/js/" files="logos.js"}
    <!-- Font Awesome -->
...
<body class="top-navigation">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content  ">
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="logos-form">
                    ...
                    <div class="row wrapper  white-bg ">
                        <div class="col-sm-12 b-l">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.Page_header_logo}:</label>
                                <div class="col-sm-3" style="height:210px;">
                                    <div class="col-sm-12 imgHeader">
                                        <img src="{$headerlogo}" height="{$headerheight}px" width="{$headerwidth}px"/>
                                    </div>
                                    <div class="col-sm-12 small">{$smarty.config.Info_header_logo}</div>
                                </div>
                                ...
                                <div class="col-sm-5">
                                    <div class="text-center" style="height:50px;">
                                        ...
                                        <div id="headerDropzone" class="dropzone dz-default dz-message" ></div>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.Login_page_logo}:</label>
                                <div class="col-sm-3" style="height:200px;">
                                    <div class="col-sm-12 imgLogin">
                                        <img src="{$loginlogo}" height="{$loginheight}px" width="{$loginwidth}px"/>
                                    </div>
                                    <div class="col-sm-12 small">{$smarty.config.Info_login_logo}</div>
                                </div>
                                <label class="col-sm-1 control-label">{$smarty.config.File}:</label>
                                <div class="col-sm-5">
                                    <div class="text-center" style="height:50px;">
                                        {*<img alt="image" class="m-t-xs img-thumbnail" src="{$person_photo}">*}
                                        <div id="loginDropzone" class="dropzone dz-default dz-message" ></div>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.Reports_logo}:</label>
                                <div class="col-sm-3" style="height:200px;">
                                    <div class="col-sm-12 imgReport">
                                        <img src="{$reportslogo}" height="{$reportsheight}px" width="{$reportswidth}px"/>
                                    </div>
                                    <div class="col-sm-12 small">{$smarty.config.Info_reports_logo}</div>
                                </div>
                                <label class="col-sm-1 control-label">{$smarty.config.File}:</label>
                                <div class="col-sm-5">
                                    <div class="text-center" style="height:10px;">
                                        {*<img alt="image" class="m-t-xs img-thumbnail" src="{$person_photo}">*}
                                        <div id="reportDropzone" class="dropzone dz-default dz-message" ></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row wrapper  white-bg ">
                        <div class="col-sm-12 b-l">
                            <div id="alert-create-module"></div>
                        </div>
                    </div>
                    ...
                    <div class="row wrapper  white-bg text-center">
                        <div class="col-sm-12 form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnCreateModule" >
    ...
    {include file='modals/modules/modal-alert-create.tpl'}
