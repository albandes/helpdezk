...
<head>
    ...
    {head_item type="js" src="$path/app/modules/admin/views/js/" files="personpermission.js"}
    ...
    {literal}
        ...
        <style>
            ...
            #alertmod_table_list_personperms {
                top: 900px !important;
            }
        </style>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>Cadastros / {$smarty.config.people} / <strong>{$smarty.config.permissions}</strong></h5>
                            </div>

                            <div class="ibox-content">
                                <input type="hidden" id="idperson" name="idperson" value="{$hidden_idperson}" />
                                ...
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_personperms"></table>
                                    <div id="pager_list_personperms"></div>
                                </div>
