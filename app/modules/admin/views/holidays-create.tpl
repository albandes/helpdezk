...
<body class="top-navigation">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.Holidays} / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
                </div>
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="create-holiday-form">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-10 b-l">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="holiday_description" name="holiday_description" class="form-control input-sm" required placeholder="{$plh_holiday_description}" value="" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <div class="input-group date">
                                        <input type="text" id="holiday_date" name="holiday_date" class="form-control input-sm" placeholder="{$plh_holiday_date}" value="" readonly />
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div id="alert-create-holiday"></div>
                        </div>
                    </div>
    ...
    {include file='modals/holidays/modal-alert-create.tpl'}
