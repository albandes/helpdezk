$(document).ready(function () {
     ...
     * */ 
    var colM = [ 
        { title: "", width: '10%', dataIndx: "idtypeperson", hidden:true, halign: "center"  },
        { title: "<b>"+vocab["Name"]+"</b> ", width: '45%', dataIndx: "name", halign: "center"  },
    ...
    var dataModel = {
        ...
        dataType: "JSON",
        method: "POST",
        url: path + '/admin/typePersonPermission/jsonGridPermissions',
        postData: {_token:$("#_token").val(),programId:$("#programId").val()},
    ...
    var obj = { 
        ...
        colModel: colM,
        editable: false,
        title: "<b>"+vocab['permissions']+" "+vocab['to']+" "+lblProgramName+"</b>",
    ...
    $("#btnSearch").click(function(){
        ...
        $("#grid_permissions").pqGrid( "option", "dataModel.postData", function(){
            return {_token:$("#_token").val(),programId:$("#programId").val(),quickSearch:true,quickValue:quickValue};
        });
 ...
 * @param  {int} userTypeId     User's type to grant or revoke permission
 * @return {void}      
 */
function grantPermission(id,programId,accessTypeId,userTypeId){
    $.ajax({
        type: "POST",
