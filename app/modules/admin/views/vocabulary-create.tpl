    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            ...
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.records} / {$smarty.config.pgr_vocabulary} / <strong>{$smarty.config.Add}</strong></h4>
                </div>
            </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-vocabulary-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" id="keyName" name="keyName" class="form-control input-sm" placeholder="{$plh_controller_description}" value="" >
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg text-center">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-md" id="btnCreateVocabulary" >
