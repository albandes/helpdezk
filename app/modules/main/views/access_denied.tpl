                        ...
                        <div class="ibox ">
                            ...
                            <div class="ibox-content text-center">
                                <div class="alert-danger">
                                    <h1>{$smarty.config.Access_denied}</h1>
                                    <h3>{$smarty.config.admin_contact_msg}</h3>
                                </div>
                                <br><br>
                                <a href="{$href}" id="btnCancel" class="btn btn-white btn-md" role="button"><i class="fa fa-arrow-alt-circle-left" aria-hidden="true"></i> {$smarty.config.Back_btn} </a>
                            </div>
                        </div>
                    </div>
                </div>
