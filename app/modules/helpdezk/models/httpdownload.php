...
/**
 * Alterado pela PIPEGREP para definir a funcao set_mime (mostrada no exemplo, mas nao definida)
 * E incluir os headers adicionais do IE ;?(
 * @since 2009-05-19
 */
class httpdownload extends Model{
	...
	//Os headers adicionais para o IE
	// Creditos a: 
	//http://www.digitaltree.com.br/blog/desenvolvimento-web/php-ie-resolvendo-problema-download-usando-content-disposition/
	header("Pragma: public");
	header("Expires: 0");
	header("Cache-Control: must-revalidate, post-check=0, pre-check=0");
	header("Content-Transfer-Encoding: binary");

	//Fim dos headers adicionais
	...
	if ($this->mime != null OR $this->filename == null) {
		return $this->mime;
	} 

	$mimetype = new mimetype();

        $this->mime = $mimetype->getType($this->filename);
	return $this->mime;
    }
