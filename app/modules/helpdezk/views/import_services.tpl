...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/helpdezk/views/js/" files="import-services.js"}
    <!-- Font Awesome -->
...
<body class="top-navigation">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content  ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.Import} / <strong>{$smarty.config.pgr_services}</strong></h4>
                    </div>
                </div>
                ...
                <form method="get" class="form-horizontal" id="logos-form">
                    ...
                    <div class="col-sm-12 b-l text-center">
                        <div id="alert-import-service"></div>
                    </div>
    ...
    {include file='modals/import-services/modal-alert.tpl'}
