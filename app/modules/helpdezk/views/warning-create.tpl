    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper    white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_warnings} / <strong>{$smarty.config.Add}</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-warning-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="title" name="title" class="form-control input-sm" required placeholder="{$plh_title}" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea class="form-control input-sm" id="description" name="description" placeholder="{$plh_description}"></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <div class="input-group date">
                                    <input type="text"  id="dtstart" name="dtstart" class="form-control input-sm" value="{$plh_dtstart}" readonly/>
                                    <span class="input-group-addon"><i class="fa fa-calendar-alt"></i></span>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <div class="input-group clockpicker">
                                    <input type="text" id="timestart" name="timestart" class="form-control input-sm" value="{$plh_timestart}" readonly/>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3 checkbox i-checks"><label> <input type="checkbox" id="warningend" name="warningend_show" checked="checked"> <i></i> &nbsp;{$smarty.config.Until_closed}</label></div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">{$smarty.config.Send_email}:</label>
                            <div class="checkbox i-checks"><label> <input type="checkbox" id="sendemailconf" value=""> <i></i> &nbsp;{$smarty.config.Send_alerts_email}</label></div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <select class="form-control input-sm" id="showin" name="showin" >
