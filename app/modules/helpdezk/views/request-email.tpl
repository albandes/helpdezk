...
<body class="top-navigation">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_email_request} / <strong>{$smarty.config.Home}</strong></h5>
                            </div>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="jqGrid_wrapper">
                                    <input type="hidden" name="_token" id= "_token" value="{$token}">
                                    <table id="table_list_request_email"></table>
                                    <div id="pager_list_request_email"></div>
                                </div>
    ...
    {include file='modals/request-email/modal-dialog-delete.tpl'}
