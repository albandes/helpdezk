...
<head>
    ...
    {head_item type="js" src="$path/app/modules/helpdezk/views/js/" files="reason.js"}
...
<body class="top-navigation">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_req_reason} / <strong>{$smarty.config.Home}</strong></h5>
                            </div>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="jqGrid_wrapper">
                                    <input type="hidden" name="_token" id= "_token" value="{$token}">
                                    <table id="table_list_reason"></table>
                                    <div id="pager_list_reason"></div>
                                </div>
    ...
    {include file='modals/hdkreason/modal-dialog-delete.tpl'}
