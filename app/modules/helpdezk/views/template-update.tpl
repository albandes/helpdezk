    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            ...
            <form method="get" class="form-horizontal" id="update-emailconf-form">
                ...
                <input type="hidden" name="idtemplate" id= "idtemplate" value="{$hidden_idtemplate}">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="templateName" name="templateName" class="form-control input-sm" value="{$tempsubject}" >
                            </div>
                        </div>
