    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content">
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="create-department-form">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-10 b-l">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="txtDepartment" name="txtDepartment" class="form-control input-sm" value="" >
                                </div>
                            </div>                           
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div id="alert-create-department"></div>
                        </div>
                    ...
                    <div class="row wrapper  white-bg text-center">
                        <div class="col-sm-12 form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnCreateDepartment" >
