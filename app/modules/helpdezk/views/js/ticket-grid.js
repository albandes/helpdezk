     ...
     * */ 
     if(typeUser == 3){
        var colM = [ 
            ...
            { title: "<b>"+vocab["Grid_opening_date"]+"</b> ", width: 112, dataIndx: "entryDate", halign: "center", style: {'font-size':'10px'}  },
            { title: "<b>"+vocab["Company"]+"</b> ", width: 60, dataIndx: "company", halign: "center", style: {"font-size":"10px"}  },
            { title: "<b>"+vocab["From"]+"</b> ", width: 150, dataIndx: "owner", halign: "center", style: {"font-size":"10px"}  },
            { title: "<b>"+vocab["Type"]+"</b> ", width: 100, dataIndx: "type", halign: "center"  },
            { title: "<b>"+vocab["Item"]+"</b> ", width: 100, dataIndx: "item", halign: "center"  },
            { title: "<b>"+vocab["Service"]+"</b> ", width: 100, dataIndx: "service", halign: "center"  },
            { title: "<b>"+vocab["Grid_subject"]+"</b> ", width: 120, dataIndx: "subject", halign: "center"  },
            ...
            { title: "<b>"+vocab["Grid_incharge"]+"</b> ", width: 100, dataIndx: "inCharge", halign: "center"  },
