...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/helpdezk/views/js/" files="createdepartment.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content">
                ...
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_departments} / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
                </div>            
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="update-department-form">

                    <!-- Hidden -->
                    <input type="hidden" name="_token" id= "_token" value="{$token}">
                    <input type="hidden" name="iddepartment" id= "iddepartment" value="{$hidden_iddepartment}">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-10 b-l">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">{$smarty.config.Department_name}:</label>
                                <div class="col-sm-5">
                                    <input type="text" id="txtDepartment" name="txtDepartment" class="form-control input-sm" value="{$txtDepartment}" >
                                </div>
                            </div>
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div id="alert-update-department"></div>
                        </div>
                    ...
                    <div class="row wrapper  white-bg text-center">
                        <div class="col-sm-12 form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnUpdateDepartment" >
