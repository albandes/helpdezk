        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_request_email_form" name="delete_request_email_form" method="post">
                        <input type="hidden" id="idgetemail_modal" name="idgetemail_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-request-email"></div>
                        </div>
                    </div>
                </div>
