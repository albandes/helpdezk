<!-- Reopen modal in user ticket page -->
<div class="modal fade"  id="modal-form-reopen" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
        ...
        <div class="modal-dialog modal-sm"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            {$smarty.config.Tckt_reopen_request}
                        </div>
                    </div>
                </div>
