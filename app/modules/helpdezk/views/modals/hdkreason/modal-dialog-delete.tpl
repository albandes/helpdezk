        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_reason_form" name="delete_reason_form" method="post">
                        <input type="hidden" id="idreason_modal" name="idreason_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-reason"></div>
                        </div>
                    </div>
                </div>
