        ...
        <div class="modal-dialog modal-lg"  role="document"> {*style="width:1250px;"*}
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="btnSendTopic" data-loading-text="<i class='fa fa-circle-notch fa-spin'></i> {$smarty.config.Processing}"><i class='fa fa-save'></i> {$smarty.config.Save}</button>
                </div>
            </div>
        </div>
    </form>
