...
<body class="top-navigation">
    ...
    <div id="wrapper">
        <div id="page-wrapper" class="gray-bg">
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-library-form">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-13 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="library" name="library" class="form-control input-sm" placeholder="{$plh_library}" >
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-library-create"></div>
                    </div>
                </div>
