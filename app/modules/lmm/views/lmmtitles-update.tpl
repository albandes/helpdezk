...
<body class="top-navigation">
    ...
    <div id="wrapper">
        <div id="page-wrapper" class="gray-bg">
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-titles-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="idtitle" id= "idtitle" value="{$idtitle}">
                            ...
                            <div class="col-sm-11 b-l">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{$smarty.config.Material_Type}:</label>
                                        <div class="col-sm-3">
                                            <select class="form-control input-sm"  id="materialtype" name="materialtype" data-placeholder="{$plh_materialtype}" value="{$materialtype}">
                            ...
                            <div class="col-sm-11 b-l">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{$smarty.config.Collection}:</label>
                                        <div class="col-sm-1">                                       
                                        <p>
                                                <input type="radio" id="sim" name="col" {$radiosim}  value="Y"/>Sim                                        
                                        
                                            </p>
                                        </div> 
                                        <div class="col-sm-1">                                       
                                        <p>                                                                                     
                                                <input type="radio" id="nao" name="col" {$radionao} value="N"/>Não
                                            </p>
                                        </div>                                     
                                </div>
                            </div>                                     
                    ...
                    <div id="Collectionline" class="row wrapper white-bg {$mostracoll}">
                        ...
                        <div class="col-sm-1 b-l"></div>
                            <div class="col-sm-11 b-l">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{$smarty.config.Collection}:</label>
                                        <div class="col-sm-3">
                                            <select class="form-control input-sm"  id="Collection" name="Collection" data-placeholder="{$plh_Collection}" value="{$Collection}" >
                    ...
                    <div class="row wrapper white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" id="titles" name="titles" class="form-control input-sm" placeholder="{$plh_titles}" value="{$titles}" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-1 b-l"></div>
                            <div class="col-sm-11 b-l">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" id="Cutter" name="Cutter" class="form-control input-sm" placeholder="{$plh_Cutter}" value="{$Cutter}" >
                                    </div>
                                    <label class="col-sm-1 control-label">{$smarty.config.ISBN}:</label>
                                    <div class="col-sm-2">
                                        <input type="text" id="ISBN" name="ISBN" class="form-control input-sm" placeholder="{$plh_ISBN}" value="{$ISBN}">
                                    </div>                                    
                                </div>
                            </div>                                     
                        ...
                        <div class="col-sm-1 b-l"></div>
                            ...
                            <div class="col-sm-11 b-l">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" id="ISSN" name="ISSN" class="form-control input-sm" placeholder="{$plh_ISSN}" value="{$ISSN}">
                                    </div> 
                                    <label class="col-sm-1 control-label">{$smarty.config.CDU}:</label>
                                    <div class="col-sm-2">
                                        <input type="text" id="CDU" name="CDU" class="form-control input-sm" placeholder="{$plh_CDU}" value="{$CDU}">
                                    </div> 
                                </div>                                   
                            </div>                                                         
                            ...
                            <div class="col-sm-11 b-l">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{$smarty.config.CDD}:</label>
                                        <div class="col-sm-3">
                                        <select class="form-control input-sm"  id="CDD" name="CDD" data-placeholder="{$plh_CDD}" value="{$CDD}">
                                            <option value="">{$smarty.config.selected} </option>
                            ...
                            <div class="col-sm-11 b-l">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{$smarty.config.Publishing_company}:</label>
                                        <div class="col-sm-3">
                                            <select class="form-control input-sm"  id="edit" name="edit" data-placeholder="{$plh_edit}" value="{$edit}">
                                                <option value="">{$smarty.config.selected} </option>
                            ...
                            <div class="col-sm-11 b-l">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">{$smarty.config.Color}:</label>
                                        <div class="col-sm-3">
                                            <select class="form-control input-sm"  id="Color" name="Color" data-placeholder="{$plh_color}" value="{$Color}">
                                                <option value="">{$smarty.config.selected} </option>
                        ...
                        <div class="col-sm-11 b-l">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.Classification}:</label>
                                    <div class="col-sm-3">
                                        <select class="form-control input-sm"  id="classif" name="classif" data-placeholder="{$plh_classif}" value="{$classif}">
                                            <option value="">{$smarty.config.selected} </option>
                                    ...
                                    <div class="tab-content">
                                        <div id="tab-1" class="tab-pane active">                                         
                                            ...
                                            {$i = $key + 1}
                                                ...
                                                <div class="exemplaryform" id="detailsTr{$i}">
                                                    <input type="hidden" id="numId" value="{$i}"/>
                                                    <input type="hidden" id="idbookcopy{$i}" name="idbookcopy[]" value="{$value.idbookcopy}" readonly>
                                                    <div class="row wrapper white-bg ">
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input type="text" id="Exemplary{$i}" name="Exemplary[]" class="form-control input-sm" placeholder="{$plh_Exemplary}" value="{$i}" readonly>
                                                                </div>
                                                                </td>
                                                                    <td class="text-center"><a href="javascript:;" id="btndelbook{$i}" onclick="removeRow(this,'tab-1','upd')" class="btn btn-danger bt-xs lbltooltip" data-toggle="tooltip" data-placement="right" title="{$smarty.config.Delete_exemplary}"><i class="fa fa-times"></i></a></td>
                                                                </tr>
                                                            </div>
                                                        </div>                  
                                                    </div>
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 text-right control-label">{$smarty.config.Library}:</label>
                                                                    <div class="col-sm-3">
                                                                        <select class="form-control input-sm"  id="Library{$i}" name="Library[]" data-placeholder="{$plh_Library}">
                                                                            <option value="">{$smarty.config.selected} </option>
                                                                            {html_options values=$Libraryids output=$Libraryvals selected=$value.Library}
                                                                        </select>
                                                                    </div>                                                           
                                                            </div>
                                                        </div>                                     
                                                    ...
                                                    <div class="row wrapper white-bg ">
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input type="date" id="aquis{$i}" name="aquis[]" class="form-control input-sm" placeholder="{$plh_aquis}" value="{$value.aquis}">
                                                                </div>
                                                            </div>
                                                        </div>                   
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 text-right control-label">{$smarty.config.Origin}:</label>
                                                                    <div class="col-sm-3">
                                                                        <select class="form-control input-sm"  id="origin{$i}" name="origin[]" data-placeholder="{$plh_origin}">
                                                                            <option value="">{$smarty.config.selected} </option>
                                                                            {html_options values=$originids output=$originvals selected=$value.origin}
                                                                        </select>
                                                                    </div>                                                           
                                                            </div>
                                                        </div>                                     
                                                    ...
                                                    <div class="row wrapper white-bg ">
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input type="text" id="Volume{$i}" name="Volume[]" class="form-control input-sm" placeholder="{$plh_Volume}" value="{$value.Volume}" >
                                                                </div>
                                                            </div>
                                                        </div>                 
                                                    </div>
                                                    ...
                                                    <div class="row wrapper white-bg ">
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input type="text" id="Edition{$i}" name="Edition[]" class="form-control input-sm" placeholder="{$plh_Edition}" value="{$value.Edition}">
                                                                </div>
                                                            </div>
                                                        </div>                   
                                                    ...
                                                    <div class="row wrapper white-bg ">
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <input type="text" id="Year{$i}" name="Year[]" class="form-control input-sm ExemplaryYear" placeholder="{$plh_Year}" value="{$value.Year}">
                                                                </div>
                                                            </div>
                                                        </div>                  
                                                        ...
                                                        <div class="col-sm-11 b-l">
                                                            <div class="form-group">
                                                                <label class="col-sm-2 text-right control-label">{$smarty.config.Comes_with_CD}:</label>
                                                                    <div class="col-sm-1">                                       
                                                                        <p>
                                                                            <input type="radio" id="sim{$i}" name="hascd[{$i}]" {if $value.cd== "Y"}checked=checked{/if} value="Y"/>Sim                                   
                                                                    
                                                                        </p>
                                                                    </div> 
                                                                    <div class="col-sm-1">                                       
                                                                        <p>                                                                                    
                                                                           <input type="radio" id="nao{$i}" name="hascd[{$i}]"  {if $value.cd== "N"}checked=checked{/if}  value="N"/>Não 
                                        ...
                                        {foreach $arrAut as $key => $value}
                                            {$i = $key + 1}

                                            <div class="authorform" id="detailsAuthor{$i}">
                                                <input type="hidden" id="nummId" value="{$i}"/>
                                                ...
                                                <div class="row wrapper white-bg ">
                                                    ...
                                                    <div class="col-sm-11 b-l">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-3">
                                                                <input type="text" id="Author{$i}" name="Author[]" class="form-control input-sm" placeholder="{$plh_Author}" value="{$i}" readonly>
                                                            </div>
                                                            </td>
                                                                <td class="text-center"><a href="javascript:;" id="btndelauthor{$i}" onclick="delRow(this,'tab-2','upd')" class="btn btn-danger bt-xs lbltooltip" data-toggle="tooltip" data-placement="right" title="{$smarty.config.Delete_author}"><i class="fa fa-times"></i></a></td>
                                                            </tr>
                                                        </div>
                                                    </div>                  
                                                </div>
                                                ...
                                                <div class="row wrapper white-bg ">
                                                    ...
                                                    <div class="col-sm-11 b-l">
                                                        <div class="form-group">                                                                                                               
                                                            ...
                                                            <div class="col-sm-4">
                                                                <select class="form-control input-sm "  id="tabAuthor{$i}" name="tabAuthor[]" data-placeholder="{$plh_Author}" onchange="loadcutter(this)">
                                                                    <option value="">{$smarty.config.selected} </option>
                                                                    {html_options values=$Authorids output=$Authorvals selected=$value.author} 
                                                                </select>
                                                            </div>
                                                            <div class="form-group">                                                         
                                                                <label class="col-sm-1 control-label">{$smarty.config.Cutter}:</label>
                                                                <div class="col-sm-3">
                                                                    <input type="text" id="tabcutter{$i}" name="tabcutter[]" value="{$value.cutter}" class="form-control input-sm" placeholder="{$plh_tabcutter}" readonly>    
                                                                </div> 
                                                                <div class="col-sm-1 ">
                    ...
                    <div class="row wrapper  white-bg ">
                        <div class="col-sm-12 b-l">
                            <div id="alert-titles-update"></div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 b-l">
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <button type="button" class="btn btn-primary btn-md " id="btnSaveUpdate" >
