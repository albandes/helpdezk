...
<body class="top-navigation">
    ...
    <div id="wrapper">
        <div id="page-wrapper" class="gray-bg">
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-situation-form">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-13 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="situation" name="situation" class="form-control input-sm" placeholder="{$plh_situation}" >
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-situation-create"></div>
                    </div>
                </div>
