...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lmm/views/js/" files="lmm-classification-grid.js"}
...
<body class="top-navigation">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_classification} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <button id="btnPattern" type="button" class="btn btn-primary btn-xs"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;{$smarty.config.Pattern}</button>
                                ...
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_classification"></table>
                                    <div id="pager_list_classification"></div>
                                </div>
    ...
    {include file='modals/classification/modal-dialog-delete.tpl'}
