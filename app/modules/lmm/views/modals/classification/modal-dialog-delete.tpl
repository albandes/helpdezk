        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_classification" name="delete_modal_classification" method="post">
                        <input type="hidden" id="idclassification_modal" name="idclassification_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-classification"></div>
                        </div>
                    </div>
                </div>
