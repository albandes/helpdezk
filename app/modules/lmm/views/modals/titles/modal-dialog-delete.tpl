        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-titles" id="myModalLabel"></h4>
                </div>

                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_titles" name="delete_modal_titles" method="post">
                        <input type="hidden" id="idtitles_modal" name="idtitles_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-titles"></div>
                        </div>
                    </div>
                </div>
