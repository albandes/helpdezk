        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_author" name="delete_modal_author" method="post">
                        <input type="hidden" id="idauthor_modal" name="idauthor_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-author"></div>
                        </div>
                    </div>
                </div>
