        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_collection" name="delete_modal_collection" method="post">
                        <input type="hidden" id="idcollection_modal" name="idcollection_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-collection"></div>
                        </div>
                    </div>
                </div>
