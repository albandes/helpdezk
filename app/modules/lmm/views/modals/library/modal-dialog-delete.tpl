        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_library" name="delete_modal_library" method="post">
                        <input type="hidden" id="idlibrary_modal" name="idlibrary_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-library"></div>
                        </div>
                    </div>
                </div>
