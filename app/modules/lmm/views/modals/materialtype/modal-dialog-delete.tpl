        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_materialtype" name="delete_modal_materialtype" method="post">
                        <input type="hidden" id="idmaterialtype_modal" name="idmaterialtype_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-materialtype"></div>
                        </div>
                    </div>
                </div>
