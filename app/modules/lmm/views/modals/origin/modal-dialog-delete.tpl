        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_origin" name="delete_modal_origin" method="post">
                        <input type="hidden" id="idorigin_modal" name="idorigin_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-origin"></div>
                        </div>
                    </div>
                </div>
