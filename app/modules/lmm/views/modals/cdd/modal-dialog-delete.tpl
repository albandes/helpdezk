        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_cdd" name="delete_modal_cdd" method="post">
                        <input type="hidden" id="idcdd_modal" name="idcdd_modal" value="" />
