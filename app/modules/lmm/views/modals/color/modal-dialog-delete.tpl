        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_color" name="delete_modal_color" method="post">
                        <input type="hidden" id="idcolor_modal" name="idcolor_modal" value="" />
