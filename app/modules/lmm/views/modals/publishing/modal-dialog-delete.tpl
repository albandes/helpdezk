        ...
        <div class="modal-dialog modal-md"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" class="form-horizontal" id="delete_modal_publishing" name="delete_modal_publishing" method="post">
                        <input type="hidden" id="idpublishing_modal" name="idpublishing_modal" value="" />
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div id="alert-delete-publishing"></div>
                        </div>
                    </div>
                </div>
