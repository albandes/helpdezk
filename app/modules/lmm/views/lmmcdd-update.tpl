...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/lmm/views/js/" files="lmmcdd-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-8">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_cdd}  / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-cdd-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="idcdd" id= "idcdd" value="{$idcdd}">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.Code}:</label>
                            <div class="col-sm-3">
                                <input type="text" id="code" name="code" class="form-control input-sm" placeholder="{$plh_code}" value="{$code}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="descr" name="descr" class="form-control input-sm" placeholder="{$plh_descr}" value="{$descr}">
                            </div>
                        </div>
                    </div>
