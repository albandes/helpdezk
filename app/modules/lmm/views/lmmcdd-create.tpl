...
<body class="top-navigation">
    ...
    <div id="wrapper">
        <div id="page-wrapper" class="gray-bg">
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-cdd-form">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-13 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="code" name="code" class="form-control input-sm" placeholder="{$plh_code}" >
                            </div>
                        </div>
                    </div>
