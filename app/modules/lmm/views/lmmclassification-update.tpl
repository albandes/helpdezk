...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/lmm/views/js/" files="lmmclassification-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-8">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_classification}  / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
            ...
            <form method="get" class="form-horizontal" id="update-classification-form">
                ...
                <input type="hidden" name="idclassification" id= "idclassification" value="{$idclassification}">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="classification" name="classification" class="form-control input-sm" placeholder="{$plh_classification}" value="{$classification}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="checkbox i-checks"><label> <input type="checkbox" id="cityDefault" name="cityDefault" value="S" {$checkdefault} > <i></i> &nbsp;{$smarty.config.Yes}</label></div>
                        </div>
                    </div>
