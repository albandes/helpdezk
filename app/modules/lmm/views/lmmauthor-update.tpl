...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/lmm/views/js/" files="lmmauthor-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-8">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_author}  / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-author-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="idauthor" id= "idauthor" value="{$idauthor}">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="author" name="author" class="form-control input-sm" placeholder="{$plh_author}" value="{$author}">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-author-update"></div>
                    </div>
                </div>
