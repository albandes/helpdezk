...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lmm/views/js/" files="lmm-titles-grid.js"}
...
<body class="top-navigation">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_titles} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_titles"></table>
                                    <div id="pager_list_titles"></div>
                                </div>
    ...
    {include file='modals/titles/modal-dialog-delete.tpl'}
