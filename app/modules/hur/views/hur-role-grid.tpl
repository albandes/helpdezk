...
<head>
    ...
    {head_item type="js" src="$path/app/modules/hur/views/js/" files="hur-role-grid.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_hurrole} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_hurrole"></table>
                                    <div id="pager_list_hurrole"></div>
                                </div>
