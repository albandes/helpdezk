...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/hur/views/js/" files="hurarea-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_hurarea}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="areaName" name="areaName" class="form-control input-sm" value="{$areaName}" placeholder="{$plh_nome}">
                            </div>
                        </div>
                    </div>
