...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/hur/views/js/" files="hurrole-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_hurrole}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-role-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="roleID" id= "roleID" value="{$hidden_roleID}">
                 ...
                 <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.Select_area}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbRoleArea" id="cmbRoleArea" >
                                    <option value="X" disabled hidden selected>{$smarty.config.Select}</option>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="roleName" name="roleName" class="form-control input-sm" value="{$roleName}" placeholder="{$plh_nome}" >
                            </div>
                        </div>
                    </div>
