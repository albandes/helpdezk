...
class Sicredi
{
	...
	public function setParams()
	{
		...
		$nossonumero = substr($this->data['idboleto'], -5);
		...
		$aRet["codigo_barras"] = $linha;
		$aRet["linha_digitavel"] = $this->monta_linha_digitavel($linha);
		$aRet["agencia_codigo"] = $agencia_codigo;
		$aRet["nosso_numero"] = $nossonumero;
		$aRet["codigo_banco_com_dv"] = $codigo_banco_com_dv;

		$aRet["cod_febraban"] = $this->data['banco'];
        $aRet['bank_logo'] = __DIR__ . "/img/logosicredi.jpg" ;
        $aRet['company_logo'] = __DIR__ . "/img/mq_logo.jpg" ;
