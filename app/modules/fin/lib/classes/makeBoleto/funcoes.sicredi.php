...
- sicredi.inc.php 		(contem as linhas inicias com tratamento de vari�veis)
- funcoes.sicredi.php 	(contem somente as fun��es)

Isto foi necess�rio para que possam ser impressos mais de um boleto.
Se deixassemos como estava as fun��es seriam redeclaradas o que ocasionaria erro.

Sempre que implantar um novo banco TEM que fazer esta separa��o
