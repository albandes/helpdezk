...
function dv_nossonumero($numero) {
	$resto2 = modulo_11_sicredi($numero, 9, 1);
...
function modulo_11_sicredi($num, $base=9, $r=0)  {
    /**
     *   Autor:
     *           Pablo Costa <pablo@users.sourceforge.net>
     *
...
function monta_linha_digitavel_sicredi($codigo) {
...
function geraCodigoSicredi($numero) {
    $parte1 = substr($numero, 0, 3);
//    $parte2 = modulo_11($parte1);
    return $parte1 . "-X";
}
