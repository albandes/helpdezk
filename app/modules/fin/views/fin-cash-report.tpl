...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/fin/views/js/" files="fincashreport.js"}
    <!-- Font Awesome -->
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_reports} / <strong>{$smarty.config.pgr_fin_cash_report}</strong></h4>
                </div>
            </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="cash-report-form">
                ...
                <div class="row wrapper border-bottom white-bg returnBox hide">
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group text-right">
                            <button type="button" class="btn btn-primary btn-md btnExport " id="btnExport" >
                                <span class="fa fa-print"></span> {$smarty.config.Print}
                            </button>
                            <button type="button" class="btn btn-primary btn-md btnCheckAll " id="btnCheckAll" >
                    ...
                    <div class="col-sm-12 b-l">
                        <div id="divReturn" class="col-sm-12">
                            <table id="returnTable" class="table table-hover table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="col-sm-1 text-center"><h3><strong> </strong></h3></th>
                                        <th class="col-sm-1 text-center"><h3><strong>{$smarty.config.ERP_Date}</strong></h3></th>
                                        <th class="col-sm-1 text-center"><h3><strong>{$smarty.config.FIN_payment_number}</strong></h3></th>
                                        <th class="col-sm-3 text-center"><h3><strong>{$smarty.config.FIN_identification}</strong></h3></th>
                                        <th class="col-sm-2 text-center"><h3><strong>{$smarty.config.ERP_Credit}</strong></h3></th>
                                        <th class="col-sm-2 text-center"><h3><strong>{$smarty.config.ERP_Debit}</strong></h3></th>
                                        <th class="col-sm-2 text-center"><h3><strong>{$smarty.config.Description}</strong></h3></th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
