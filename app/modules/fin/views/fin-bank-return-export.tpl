...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/fin/views/js/" files="finbankreturnexport.js"}
    <!-- Font Awesome -->
    ...
    <!-- FileSaver -->
    {head_item type="js"  src="$path/app/modules/fin/lib/js/plugins/FileSaver/" files="FileSaver.min.js"}
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_reports} / <strong>{$smarty.config.pgr_fin_bank_return_export}</strong></h4>
                </div>
            </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="bank-return-export-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.ERP_Bank}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" id="cmbBank" name="cmbBank" >
                                    {html_options values=$bankids output=$bankvals selected=$idbank}
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-bank-return-export"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group text-right">
                            <button type="button" class="btn btn-primary btn-md btnExport " id="btnExport" >
                                <span class="fa fa-file-export"></span> {$smarty.config.Export}
                            </button>
                    ...
                    <div class="col-sm-12 b-l">
                        <div id="divReturn" class="col-sm-12">
                            <table id="returnTable" class="table table-hover table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th class="col-sm- text-center"><h3><strong> </strong></h3></th>
...
{include file='modals/bankreturnexport/modal-not-export.tpl'}
