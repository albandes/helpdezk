...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/fin/views/js/" files="remittancereport.js"}
    <!-- Font Awesome -->
...
<body class="top-navigation">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>Cadastros / Arquivos Remessa / <strong>Verifica&ccedil;&atilde;o</strong></h4>
                    </div>
                ...
                <form method="get" class="form-horizontal" id="insert-form" name="insert-form">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-10 b-l">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.pgr_erp_paymentfile}:</label>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-check-remittance"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12" style="text-align: center">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnCheckFile" >
                                    <span class="fa fa-check"></span>  &nbsp;Processar
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    {include file='modals/bankremittancerep/modal-alert.tpl'}
