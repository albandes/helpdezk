...
<html>
    <head>
        ...
        {head_item type="js" src="$path/app/modules/fin/views/js/" files="bankslipemail.js"}
                        ...
                        <div class="col-lg-12">
                            <div class="ibox ">
                                ...
                                <div class="ibox-title">
                                    <h5>{$smarty.config.cat_utils} / {$smarty.config.pgr_fin_bankslip_email} / <strong>{$smarty.config.lbl_list_emails}</strong></h5>
                                ...
                                <div class="ibox-content">
                                    <div class="row wrapper">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="hidden" name="scheduleID" id= "scheduleID" value="{$hidden_idschedule}">
                                            <button id="btnEcho"   type="button" class="btn btn-primary btn-xs"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;{$smarty.config.GES_Ver}</button>
                                            <button id="btnBack" type="button" class="btn btn-primary btn-xs"><i class="fa fa-arrow-circle-left" aria-hidden="true""></i>&nbsp;{$smarty.config.Back_btn}</button>
                                        </div>
                                        <div class="col-lg-6">
                                            <div id="alert-check-remittance" class="alert-warning">
                                                {$scheduleList}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row wrapper">
                                        <div class="jqGrid_wrapper">
                                            <table id="table_list_emails"></table>
                                            <div id="pager_list_emails"></div>
                                        </div>
                                    </div>
