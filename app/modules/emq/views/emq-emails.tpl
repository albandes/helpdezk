...
<head>
    ...
    {head_item type="js" src="$path/app/modules/emq/views/js/" files="emails.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_utils} / {$smarty.config.emq_pgr_email} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <button id="btnCreate" type="button" class="btn btn-primary btn-xs"><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;{$smarty.config.Send_email}</button>
