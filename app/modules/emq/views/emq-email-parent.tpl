...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/emq/views/js/" files="emailparent.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content  ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>Cadastros / {$smarty.config.emq_pgr_email_parent} / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
                </div>
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="create-email-parent">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" id="enrollmentId" name="enrollmentId" class="form-control input-sm" placeholder="{$plh_module_description}" value="" >
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-3 control-label">{$smarty.config.email}:</label>
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <input type="text" id="txtEmail" name="txtEmail" class="form-control input-sm" value="" />
                                        <span class="input-group-btn">
                                           <button class="btn btn-primary input-sm" type="button">@ser.marioquintana.com.br</button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row wrapper  white-bg ">
                        <div class="col-sm-12 b-l">
                            <div id="alert-create-email-parent"></div>
                        </div>
                    </div>
                    ...
                    <div class="row wrapper  white-bg text-center">
                        <div class="col-sm-12 form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnCreateEmailParent" >
