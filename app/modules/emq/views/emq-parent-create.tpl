...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    ...
                    <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_emq_parents} / <strong>{$smarty.config.Add}</h4>
        ...
        <!-- Form area -->
        <form method="get" class="form-horizontal" id="create-parent-form" enctype="multipart/form-data">
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="parentName" name="parentName" class="form-control input-sm"  value="" />
                        </div>
                    </div>
                </div>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="parentCpf" name="parentCpf" class="form-control input-sm"  value="" />
                        </div>
                    </div>
                </div>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="parentEmail" name="parentEmail" class="form-control input-sm" value="" />
                        </div>
                    ...
                    <div class="col-sm-12">
                        <table id="studentList" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <select class="form-control input-sm" id="idstudent1" name="idstudent[]" >
                                            {html_options values=$studentids output=$studentvals}
                                        </select>
                                        <input type="hidden" id="numId" value="1"/>
                                    </td>
                                    <td>
                                        <select class="form-control input-sm" id="idkinship1" name="idkinship[]" >
                                            {html_options values=$kinshipids output=$kinshipvals}
                                        </select>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" id="checkEmailSms1" name="checkEmailSms[]" value="1"/>
                                    </td>
                                    <td class="text-center">
                                        <input type="checkbox" id="checkBankTicket1" name="checkBankTicket[]" value="1"/>
                                    </td class="text-center">
                                    <td class="text-center">
                                        <input type="checkbox" id="checkAccessApp1" name="checkAccessApp[]" value="1"/>
                                    </td class="text-center">
                                    <td class="text-center">
                                        <a href="javascript:;" onclick="removeRow(this,'studentList','new')" class="btn btn-danger bt-xs"><i class="fa fa-times"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
            ...
            <div class="row wrapper  white-bg ">
                <div class="col-sm-12 b-l">
                    <div id="alert-create-parent"></div>
                </div>
            </div>
            ...
            <div class="row wrapper  white-bg text-center">
                <div class="col-sm-12 form-group">
                    ...
                    <button type="button" class="btn btn-primary btn-md " id="btnCreateParent" >
