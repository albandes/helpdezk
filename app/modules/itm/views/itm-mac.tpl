...
<head>
    ...
    {head_item type="js" src="$path/app/modules/itm/views/js/" files="mac.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>Cadastros / {$smarty.config.itm_Title_MacAddress} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_macs"></table>
                                    <div id="pager_list_macs"></div>
                                </div>
