...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="acdclassreg-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_classreg}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-classreg-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="classID" id= "classID" value="{$hidden_classID}">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbClassCourse" id="cmbClassCourse" >
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.acd_serie}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbClassSerie" id="cmbClassSerie" >
                                    <option value="">{$smarty.config.Select}</option>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.acd_class_name}:</label>
                            <div class="col-sm-5">
                                <input type="text" id="className" name="className" class="form-control input-sm" value="{$class_name}" placeholder="{$plh_name}"> 
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.nome_abrev}:</label>
                            <div class="col-sm-3">
                                <input type="text" id="classNameAbrev" name="classNameAbrev" class="form-control input-sm" value="{$class_abrev}" placeholder="{$plh_abrev}"> 
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-classreg-update"></div>
                    </div>
                </div>
