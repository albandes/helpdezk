...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="enrollmentreport.js"}
    <!-- Font Awesome -->
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_reports} / <strong>{$smarty.config.pgr_enrollment_report}</strong></h4>
                </div>
            </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="enrollment-report-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbEnrollmentStatus" id="cmbEnrollmentStatus" >
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.acd_academic_year}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm"  id="cmbYear" name="cmbYear" >
                                    {html_options values=$yearids output=$yearvals selected=$idyear}
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.acd_course}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm"  id="cmbCourse" name="cmbCourse" >
                                    <option value="">{$smarty.config.Select}</option>
                                    <option value="X">{$smarty.config.all}</option>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.TMS_Serie}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" id="cmbSerie" name="cmbSerie" data-placeholder="{$smarty.config.Select_course}" >
                                    <option value=""></option>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.TMS_Turma_single}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" id="cmbClass" name="cmbClass" data-placeholder="{$smarty.config.Select_serie}" >
                                    <option value=""></option>
                                    {html_options values=$classids output=$classvals selected=$idclass}
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.Lbl_period_from}:</label>
                            <div class="col-sm-3">
                            ...
                            <label class="col-sm-1 control-label">{$smarty.config.Lbl_to}</label>
                            <div class="col-sm-3">
                                <div class="input-group date">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-enrollment-report"></div>
                    </div>
                </div>
...
{include file='modals/acdenrollmentreport/modal-export.tpl'}
{include file='modals/acdenrollmentreport/modal-web-print.tpl'}
