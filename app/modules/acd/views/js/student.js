$(document).ready(function () {
    ...
    grid.jqGrid({
        url: path+"/acd/acdStudent/jsonGrid",
        datatype: "json",
        mtype: 'POST',
    ...
    $("#btnCreate").click(function(){
        location.href = path + "/acd/acdStudent/formCreateStudent" ;
    });
    ...
    $("#btnUpdate").click(function(){
        ...
        if (!idPerson) {
            ...
            $('#modal-notification').html('Marque um aluno.');
            $("#tipo-alert").attr('class', 'alert alert-danger');
            $('#modal-alert').modal('show');
        } else {
            location.href = path + "/acd/acdStudent/formUpdateStudent/idperson/" + idPerson ;
        }
    });
