        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_acd_attendance}  / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-attendance-form">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbStudent" id="cmbStudent" >
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 form-control-static" id="parents-line">{$smarty.config.select_student}</div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea rows="4" cols="100" id="otherPeople" name="otherPeople" class="form-control input-sm" placeholder="{$plh_motivo}"></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                            <input type="text" id="subject" name="subject" class="form-control input-md" value="" >
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div id="line_dtstart"class="col-sm-3">
                                <div class="input-group date">
                                    <input type="text"  id="dtstart" name="dtstart" class="form-control input-sm" value="" readonly/>
                                    <span class="input-group-addon"><i class="fa fa-calendar-alt"></i></span>
                                </div>
                            </div>
                            <div id="line_timeend"class="col-sm-2">
                                <div class="input-group clockpicker">                                    
                                    <input type="text" id="timestart" name="timestart" class="form-control input-sm" value="" readonly/>
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 form-group">
                                <div class="col-sm-4">
                                    <input type="number" id="strHour" name="strHour" class="form-control input-sm text-right" value="01" min="0" max="3" step="1"/>
                                </div>
                                <div class="col-sm-2 form-control-static">
                                    {$smarty.config.Hours}
                                </div>
                                <div class="col-sm-4">
                                    <input type="number" id="strMinute" name="strMinute" class="form-control input-sm text-right" value="00"min="0" max="59" step="5"/>
                                </div>
                                <div class="col-sm-2 form-control-static">
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-attendance-create"></div>
                    </div>
                </div>
