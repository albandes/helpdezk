...
<head>
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="acd-knowledgearea-grid.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_knowledge} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_knowledgearea"></table>
                                    <div id="pager_list_knowledgearea"></div>
                                </div>
