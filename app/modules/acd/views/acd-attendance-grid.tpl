...
<head>
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="acd-attendance-grid.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_acd_attendance} / <strong>{$smarty.config.Home}</strong></h5>
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="input-group input-group-sm">
                                            <input type="text" id="txtSearch" name="txtSearch" class="form-control" placeholder="{$smarty.config.quick_search}">
                                    ...
                                    <div class="col-sm-7">
                                        <button id="btnCreate" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;{$smarty.config.New}</button>
                                        <button id="btnUpdate" type="button" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i>&nbsp;{$smarty.config.edit}</button>
                                        {*<button id="btnTimer" type="button" class="btn btn-primary btn-sm"><i class="fa fa-stopwatch" aria-hidden="true"></i>&nbsp;{$smarty.config.Timer}</button>*}
                                    </div>                               
                                    
                                </div> <br>
                                
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_attendance"></table>
                                    <div id="pager_list_attendance"></div>
                                </div>
