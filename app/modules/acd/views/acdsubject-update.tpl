...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="acdsubject-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_subject}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-subject-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="subID" id= "subID" value="{$hidden_subID}">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.area_conhecimento}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbSubArea" id="cmbSubArea" >
                                    <option value="">{$smarty.config.Select}</option>
                                    {html_options values=$areasIds output=$areasVals selected=$idArea}
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="subjectName" name="subjectName" class="form-control input-sm" value="{$subject_name}" placeholder="{$plh_nome}"> 
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.Abbreviation}:</label>
                            <div class="col-sm-3">
                                <input type="text" id="subjectAbrev" name="subjectAbrev" class="form-control input-sm" value="{$subject_abrev}" placeholder="{$plh_sigla}"> 
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-subject-update"></div>
                    </div>
                </div>
