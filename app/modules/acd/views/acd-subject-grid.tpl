...
<head>
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="acd-subject-grid.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_subject} / <strong>{$smarty.config.Home}</strong></h5>
