...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="acd-attendance-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-6">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_acd_attendance}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-attendance-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id="_token" value="{$token}">
                <input type="hidden" name="idattendance" id="idattendance" value="{$hidden_idattendance}">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbStudent" id="cmbStudent" disabled=disabled>
                                    <option value="" disabled hidden>{$smarty.config.Select}</option>
                                    {html_options values=$studentids output=$studentvals selected=$idstudent}
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.pgr_emq_parents}:</label>
                            <div class="col-sm-5 form-control-static" id="parents-line">{$parentlist}</div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.other_people}:</label>
                            <div class="col-sm-5">
                                <textarea rows="4" cols="100" id="otherPeople" name="otherPeople" class="form-control input-sm" placeholder="{$plh_motivo}">{$otherpeople}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                            <input type="text" id="subject" name="subject" class="form-control input-md" value="{$subject}" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.itm_description}:</label>
                            <div class="col-sm-8">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">{$smarty.config.Date}:</label>
                            {if $flgUpdDate == '1'}
                            <div id="line_dtstart"class="col-sm-3">
                                <div class="input-group date">
                                    <input type="text"  id="dtstart" name="dtstart" class="form-control input-sm" value="{$dtstart}" readonly/>
                                    <span class="input-group-addon"><i class="fa fa-calendar-alt"></i></span>
                                </div>
                            </div>
                            <div id="line_timeend"class="col-sm-2">
                                <div class="input-group clockpicker">                                    
                                    <input type="text" id="timestart" name="timestart" class="form-control input-sm" value="{$timestart}" readonly/>
                                    <span class="input-group-addon"><i class="fa fa-clock"></i></span>
                                </div>
                            </div>
                            {else}
                            <div id="line_dtstart"class="col-sm-5 form-control-static">
                                {$dtstart} {$timestart}
                                <input type="hidden"  id="dtstart" name="dtstart" value="{$dtstart}"/>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">{$smarty.config.duration}:</label>
                            <div class="col-sm-5 form-group">
                                <div class="col-sm-4">
                                    <input type="number" id="strHour" name="strHour" class="form-control input-sm text-right" value="{$strHour}" min="0" max="3" step="1" onchange="if(parseInt(this.value,10)<10)this.value='0'+this.value;"/>
                                </div>
                                <div class="col-sm-2 form-control-static">
                                    {$smarty.config.Hours}
                                </div>
                                <div class="col-sm-4">
                                    <input type="number" id="strMinute" name="strMinute" class="form-control input-sm text-right" value="{$strMin}"min="0" max="59" step="5" onchange="if(parseInt(this.value,10)<10)this.value='0'+this.value;"/>
                                </div>
                                <div class="col-sm-2 form-control-static">
                                    {$smarty.config.Minutes}
                                </div>
                            </div>                            
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-attendance-update"></div>
                    </div>
                </div>
