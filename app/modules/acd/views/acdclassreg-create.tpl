        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_classreg}  / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-classreg-form">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l serie_combo hide">
                        <div class="form-group">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="className" name="className" class="form-control input-sm" placeholder="{$plh_name}" >
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="classNameAbrev" name="classNameAbrev" class="form-control input-sm" placeholder="{$plh_abrev}" >
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-classreg-create"></div>
                    </div>
                </div>
