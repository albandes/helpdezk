        ...
        <div class="wrapper wrapper-content  ">
            ...
            <div class="row wrapper    white-bg ">
                <div class="col-sm-4">
                    ...
                    <h4>Cadastros / Aluno / <strong>Novo</strong></h4>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-student-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="idlegacy" name="idlegacy" class="form-control input-sm" required placeholder="{$plh_idlegacy}" >
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="matricula" name="matricula" class="form-control input-sm" required placeholder="{$plh_matricula}" >
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div id="alert-create-student"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnCreateStudent" >
            ...
            <div>
                ...
                {include file='modals/acdstudent/modal-alert-create.tpl'}
