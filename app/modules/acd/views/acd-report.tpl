...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/acd/views/js/" files="acdreport.js"}
    <!-- Font Awesome -->
    ...
    <!-- Datapicker  -->
    {head_item type="css" src="$path/css/plugins/datapicker/" files="datepicker3.css"}
    {head_item type="js"  src="$path/includes/js/plugins/datapicker/datapicker/" files="bootstrap-datepicker.js"}
    <!-- Helpdezk CSS -->
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Relatórios / Indicadores / <strong>Notas</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="acd-report-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control input-sm"  id="cmbReportType" name="cmbReportType" >
                                    {html_options values=$reptypeids output=$reptypevals selected=$idreptype}
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control input-sm"  id="cmbAcdYear" name="cmbAcdYear" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control input-sm"  id="cmbCourse" name="cmbCourse" >
                                    {html_options values=$courseids output=$coursevals selected=$idcourse}
                                </select>
                            </div>
                        </div>

                        <div class="form-group" id="line_area">
                            <label class="col-sm-2 control-label">&Aacuterea:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm"  id="cmbArea" name="cmbArea" >
                                    {html_options values=$areaids output=$areavals selected=$idarea}
                                </select>
                            </div>
                        </div>

                        <div class="form-group" id="line_disciplina">
                            <label class="col-sm-2 control-label">Disciplina:</label>
                            <div class="col-sm-3">
                                <select class="form-control input-sm"  id="cmbDisciplina" name="cmbDisciplina" >
                                    {html_options values=$discids output=$discvals}
                                </select>
                            </div>
                        </div>

                        <div class="form-group" id="line_serie">
                            <label class="col-sm-2 control-label">S&eacute;rie:</label>
                            <div class="col-sm-3">
                                <select class="form-control input-sm"  id="cmbSerie" name="cmbSerie" >
                                    {html_options values=$serieids output=$serievals selected=$idserie}
                                </select>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-sm-2 control-label">Considerar Recupera&ccedil;&atilde;o:</label>
                            <div class="checkbox i-checks"><label> <input type="checkbox" id="flagrec" name="flagrec" value=""> <i></i> &nbsp;Sim</label></div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div id="alert-create-warning"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12" style="text-align: center">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnPrintReport" >
