...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <!-- Form area -->
        <form method="get" class="form-horizontal" id="update-pedidoaprovador-form">

            <!-- Hidden -->
            <input type="hidden" id="idpedidoaprovador" value="{$hidden_idpedidoaprovador}" />
            <input type="hidden" name="_token" id= "_token" value="{$token}">
            <input type="hidden" id="typeoperation" value="{$hidden_typeoperation}" />
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="nomestatus" name="nomestatus" class="form-control input-sm"  value="{$nomestatus}" readonly />
                        </div>
                ...
                <div class="col-sm-12 b-l pedido" id="pedido">
                    <div class="col-sm-12">
                        <table class="table table-hover">
                            <thead>
                            <tr>
                                <th class="col-sm-7 text-center"><h3><strong>{$smarty.config.scm_Item}</strong></h3></th>
                            ...
                            {foreach $arrItens as $key => $value}
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" id="quantidades" name="quantidades[{$value.iditempedido}]" class="form-control text-center" placeholder="{$plh_quantidade}" step="0.25" value="{$value.quantidade}" readonly/>
                                    </td>
                                    <td>
