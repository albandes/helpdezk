...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="createrelatorioestoque.js"}
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="relatorioestoque.js"}
    <!-- Font Awesome -->
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            ...
            <div class="row wrapper    white-bg ">
                <div class="col-sm-4">
                    ...
                    <h4>Relatório de Estoque <strong></strong></h4>
        ...
        <!-- Form area -->
        <form method="get" class="form-horizontal" id="relatorioestoque-form">
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control input-sm"  id="idtipo" name="idtipo" >
                                {html_options values=$tipoids output=$tipovals selected=$idtipo}
                            </select>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group datainicial">
                        <label class="col-sm-2 control-label">Período de:</label>
                        <div class="col-sm-3">
                            <input type="date" id="datainicial" name="datainicial" class="form-control input-sm" placeholder="" />
                        </div>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group datafinal">
                        <label class="col-sm-2 control-label">até:</label>
                        <div class="col-sm-3">
                            <input type="date" id="datafinal" name="datafinal" class="form-control input-sm" placeholder="" />
                        </div>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control input-sm produtos" id="idproduto" name="idproduto"  >
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group situacao">
                        <label class="col-sm-2 control-label">Situação produtos:</label>
                        <div class="col-sm-5">
                            <input type="radio" name="situacao" value="E" class="control-label" checked><label class="control-label">Em estoque</label>
                            <input type="radio" name="situacao" value="S" class="control-label"><label class="control-label">Sem estoque</label>
                            <input type="radio" name="situacao" value="T" class="control-label"><label class="control-label">Todos</label>
                        </div>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    <div id="alert-create-relatorioestoque"></div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <button type="button" class="btn btn-primary btn-md btnPrint " id="btnPrint" >
                                <span class="fa fa-check"></span>  &nbsp;Imprimir
                            </button>
                        </div>
