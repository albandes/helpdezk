    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Fornecedor / <strong>Visualizar</strong></h4>
                </div>
        ...
        <!-- Form area -->
        <form method="get" class="form-horizontal" id="echo-fornecedor-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="nomefantasia" name="nomefantasia" class="form-control input-sm"  placeholder="{$plh_nomefantasia}" value="{$nomefantasia}" readonly >
                            </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        ...
                        <div class="form-group" id="fisica1">
                            ...
                            <div class="col-sm-2">
                                <input type="text"  id="cpf_echo" class="form-control input-sm" placeholder="{$plh_cpf}"  value="{$cpf}" readonly />
                            </div>
                        ...
                        <div class="form-group" id="juridica1">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="ein_cnpj_echo" name="ein_cnpj" class="form-control input-sm" placeholder="{$plh_ein_cnpj}" value="{$ein_cnpj}" readonly />
                            </div>
