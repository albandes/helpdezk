...
<head>
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="pedidocompra.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                ...
                                <button id="btnRemove" type="button" class="btn btn-primary btn-xs {$display_btn_delete}"><i class="fa fa-times" aria-hidden="true"></i>&nbsp;Excluir</button>
