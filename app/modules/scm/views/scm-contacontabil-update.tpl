...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="createcontacontabil.js"}
    <!-- Font Awesome -->
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Conta Contábil / <strong>Editar</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-contacontabil-form">

                <!-- Hidden -->
                <input type="hidden" id="idcontacontabil" value="{$hidden_idcontacontabil}" />
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control input-sm"  id="idcentrocusto" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="codigo" name="codigo" class="form-control input-sm" required placeholder="{$plh_codigo}" value="{$codigo}" >
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-update-contacontabil"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnUpdateContaContabil" >
