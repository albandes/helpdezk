    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Centro de Custo / <strong>Visualizar</strong></h4>
                </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control input-sm" value="{$codigo}" readonly />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 ">
                                {if $tipo == "C"}
                                     <input type="text" class="form-control input-sm" value="Crédito" readonly />
                                {else}
                                    <input type="text" class="form-control input-sm" value="Débito" readonly />
                                {/if}
                            </div>
