...
<head>
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="entradaproduto.js"}
...
<body class="top-navigation">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>Cadastros / Entrada de Produto  / <strong>Home</strong></h5>
    ...
    {include file='modals/entradaproduto/modal-remove.tpl'}
