...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            ...
            <div class="row wrapper    white-bg ibox-title">
                <div class="col-sm-4">
                    ...
                    <h4>Cadastros / Pedido / <strong>Troca</strong></h4>
        ...
        <!-- Form area -->
        <form method="get" class="form-horizontal" id="exchange-pedidooperador-form" enctype="multipart/form-data">
                        ...
                        <table id="itemList" class="table table-hover table-striped">
                            ...
                            {foreach $arrItens as $key => $value}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" id="quantidades_{$key}" name="quantidades[{$value.iditempedido}]" class="form-control input-sm text-right" placeholder="{$plh_quantidade}" value="{$value.quantidade}" step="0.25" min="0" onkeyup="checkAvailability(this)" onchange="checkAvailability(this)" readonly />
                                    </td>
                                    <!--<td>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    <div id="alert-exchange-pedidooperador"></div>
                </div>
            </div>
                ...
                <div class="col-sm-12 b-l">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnSaveExchange" >
