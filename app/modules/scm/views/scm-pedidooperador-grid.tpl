...
<head>
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="pedidooperador.js"}
...
<body class="top-navigation">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-content">
                                ...
                                <button id="btnPrint"  type="button" class="btn btn-primary btn-xs"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Comp. Retirada</button>
                                <button id="btnNote" type="button" class="btn btn-primary btn-xs"><i class="fa fa-comments" aria-hidden="true"></i>&nbsp;Apontamentos</button>
                                <button id="btnExchange" type="button" class="btn btn-primary btn-xs"><i class="fas fa-exchange-alt" aria-hidden="true"></i>&nbsp;Trocar</button>
    ...
    {include file='modals/pedidooperador/modal-delivery.tpl'}
    {include file='modals/pedidooperador/modal-note.tpl'}
    {include file='modals/pedidooperador/modal-exchange.tpl'}
