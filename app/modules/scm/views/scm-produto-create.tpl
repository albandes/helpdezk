    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_records} / {$smarty.config.scm_pgr_produto} / <strong>{$smarty.config.New}</strong></h4>
                </div>
            </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-produto-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <textarea id="descricao" name="descricao" class="form-control input-sm"  required placeholder="{$plh_descricao}" value="{$descricao}" ></textarea>
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-create-produto"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-primary btn-md" id="btnCreateProduto" >
            ...
            {include file='modals/produto/modal-alert-create.tpl'}
