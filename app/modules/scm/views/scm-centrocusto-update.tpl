    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Centro de Custo / <strong>Editar</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-centrocusto-form">

                <!-- Hidden -->
                <input type="hidden" id="idcentrocusto" value="{$hidden_idcentrocusto}" />
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-update-centrocusto"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnUpdateCentroCusto" >
            ...
            <div class="footer">
                ...
                {include file='modals/centrocusto/modal-alert.tpl'}
