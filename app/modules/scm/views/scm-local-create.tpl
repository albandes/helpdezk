...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="createlocal.js"}
    <!-- Font Awesome -->
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Local / <strong>Novo</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-local-form">
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnCreateLocal" >
            ...
            <div class="footer">
                ...
                {include file='modals/local/modal-alert-create.tpl'}
