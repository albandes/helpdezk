    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_scm_baixa_produto} / <strong>{$smarty.config.TMS_Visualiza}</strong></h4>
                </div>
        ...
        <form method="get" class="form-horizontal" id="update-entradaproduto-form">
            ...
            <div class="row wrapper white-bg">
                ...
                <div class="col-sm-11 b-l">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <textarea rows="6" cols="100" id="motivo" name="motivo" class="form-control-static input-sm" readonly placeholder="{$plh_motivo}">
                                {$motivo}
                            </textarea>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 b-l">
                    ...
                    <div class="col-sm-10 b-l">
                        <table id="itemList" class="table table-hover">
                            <thead>
                            <tr>
                                <th class="col-sm-10 text-center"><h4><strong>{$smarty.config.Item}</strong></h4></th>
                            ...
                            {foreach $arrItens as $key => $value}
                                <tr>
                                    <td class="text-left">
                                        <input type="hidden" id="iditembaixas_{$key}" name="iditembaixas[]" value="{$value.iditembaixa}" readonly>
                                        {$value.nome}
                                        <input type="hidden" id="numId" value="{$key}"/>
                                    </td>
                                    <td class="text-right">
                                        <input type="number" name="quantidades[]" id="quantidades_{$key}" class="form-control input-sm text-right" placeholder="{$plh_quantidade}" step="0.25" min="0" value="{$value.quantidade}" readonly />
                                    </td>
                                </tr>
                            {/foreach}
                            </tbody>
            ...
            <div class="row wrapper  white-bg ">
                <div class="col-sm-12 b-l">
                    <div id="alert-echo-baixaproduto"></div>
                </div>
            </div>
