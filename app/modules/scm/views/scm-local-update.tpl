    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Local / <strong>Editar</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-local-form">

                <!-- Hidden -->
                <input type="hidden" id="idlocal" value="{$hidden_idlocal}" />
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnUpdateLocal" >
            ...
            <div class="footer">
                ...
                {include file='modals/local/modal-alert.tpl'}
