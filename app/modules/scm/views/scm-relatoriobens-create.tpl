...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="createrelatoriobens.js"}
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="relatoriobens.js"}
    <!-- Font Awesome -->
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            ...
            <div class="row wrapper    white-bg ">
                <div class="col-sm-4">
                    ...
                    <h4>Relatório de Bens <strong></strong></h4>
        ...
        <!-- Form area -->
        <form method="get" class="form-horizontal" id="relatoriobens-form">
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <select class="form-control input-sm bens"  id="idbaixa" name="idbaixa" >
                                {html_options values=$baixaids output=$baixavals selected=$idbaixa}
                            </select>
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="radio" name="valor" value="S" class="control-label" checked><label class="control-label">Sim</label>
                            <input type="radio" name="valor" value="N" class="control-label"><label class="control-label">Não</label>
                        </div>
