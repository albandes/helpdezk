    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Fornecedor / <strong>editar</strong></h4>
                </div>
        ...
        <!-- First Line -->
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-fornecedor-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="radio"  name="tipo" value="2" class="control-label" {$tipojuridico}><label class="control-label">Jurídica</label>
                                <input type="radio" name="tipo" value="1" class="control-label" {$tipofisico}><label class="control-label">Física</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group" >
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="nomefantasia" name="nomefantasia" class="form-control input-sm"  placeholder="{$plh_nomefantasia}" value="{$nomefantasia}" >
                            </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        ...
                        <div class="form-group" id="fisica1">
                            ...
                            <div class="col-sm-2">
                                <input type="text"  id="cpf" name= "cpf" class="form-control input-sm" placeholder="{$plh_cpf}"  value="{$cpf}"/>
                            </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-update-fornecedor"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnUpdateFornecedor" >
