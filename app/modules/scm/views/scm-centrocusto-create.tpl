...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/scm/views/js/" files="createcentrocusto.js"}
    <!-- Font Awesome -->
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Centro de Custo / <strong>Novo</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-centrocusto-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="codigo" name="codigo" class="form-control input-sm" required placeholder="{$plh_codigo}" >
                            </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-create-centrocusto"></div>
                    </div>
                </div>
                ...
                <div class="row wrapper  white-bg text-center">
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <a href="" id="btnCancel" class="btn btn-white btn-md" role="button"><i class="fa fa-arrow-alt-circle-left" aria-hidden="true"></i> Cancela </a>
                                <button type="button" class="btn btn-primary btn-md " id="btnCreateCentroCusto" >
            ...
            <div class="footer">
                ...
                {include file='modals/centrocusto/modal-alert-create.tpl'}
