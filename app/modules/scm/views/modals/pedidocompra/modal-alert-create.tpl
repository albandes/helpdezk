        ...
        <div class="modal-dialog modal-sm"  role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Pedido cadastrado
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            Pedido:&nbsp; <spam id="modal-idpedidocompra"></spam>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-sm-12">
                            Motivo:&nbsp; <spam id="modal-motivo"></spam>
                        </div>
                    </div>

                    <div id="replicateAlert" class="row hide">
                        <div class="col-sm-12">
                            Obs:&nbsp; <spam id="modal-replicate-alert"></spam>
                        </div>
                    </div>
