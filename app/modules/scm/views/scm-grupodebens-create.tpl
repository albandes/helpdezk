        ...
        <div class="wrapper wrapper-content  ">
            ...
            <div class="row wrapper    white-bg ">
                <div class="col-sm-4">
                    ...
                    <h4>Cadastros / Grupo de Bens / <strong>Novo</strong></h4>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-grupodebens-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="radio" name="depreciacao" value="S" class="control-label" checked><label class="control-label">Sim</label>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div id="alert-create-grupodebens"></div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <button type="button" class="btn btn-primary btn-md " id="btnCreateGrupoDeBens" >
            ...
            <div class="footer">
                ...
                {include file='modals/grupodebens/modal-alert-create.tpl'}
