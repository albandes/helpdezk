    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>Cadastros / Entrada Produto / <strong>Novo</strong></h4>
                </div>
        ...
        <!-- Form area -->
        <form method="get" class="form-horizontal" id="create-entradaproduto-form">
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <label class="radio-inline i-checks"><input type="radio" name="tipo" value="C" class="control-label" checked>&nbsp;&nbsp;Compra</label>
                            <label class="radio-inline i-checks"> <input type="radio" name="tipo" value="L" class="control-label">&nbsp;&nbsp;Lista de Materiais</label>
                        </div>
                    </div>
            ...
            <div class="row wrapper  white-bg numeropedidodiv">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="numeropedido" name="numeropedido" class="form-control input-sm"  placeholder="{$plh_numeropedido}" >
                        </div>
            ...
            <div class="row wrapper  white-bg notafiscaldiv">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="numeronotafiscal" name="numeronotafiscal" class="form-control input-sm"  placeholder="{$plh_numeronotafiscal}" >
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group date">
                                <input type="text" id="dtnotafiscal" name="dtnotafiscal" class="form-control input-sm" placeholder="{$plh_dtnotafiscal}" value="" readonly />
            ...
            <div class="row wrapper  white-bg fornecedordiv">
                ...
                <div class="col-sm-10 b-l pedido" id="pedido">
                    ...
                    <div class="form-group  itenspedidolayout" >
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="number" id="quantidades" name="quantidades[]" class="form-control input-sm quantidades" placeholder="{$plh_quantidade}" step="0.25" min="0" />
                        </div>

                        <div class="col-sm-2">
                            <label class="control-label">Valor:</label>
                            <input type="text" id="valores" name="valores[]" class="form-control input-sm valores" >
                        </div>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="valorestotais" name="valorestotais" class="form-control input-sm"  placeholder="{$plh_valorestotais}" >
                        </div>
            ...
            <div class="row wrapper white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="valorestotaisnotafiscal" name="valorestotaisnotafiscal" class="form-control input-sm"  placeholder="{$plh_valornota}" >
                        </div>
            ...
            <div class="row wrapper  white-bg ">
                ...
                <div class="col-sm-11 b-l">
                    <div id="alert-create-entradaproduto"></div>
                </div>
            </div>
                ...
                <div class="col-sm-12 b-l">
                    <div class="form-group">
                        <div class="col-sm-12">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnCreateEntradaProduto" >
        ...
        <div class="row border-bottom white-bg ">
            ...
            {include file='modals/entradaproduto/modal-alert-create.tpl'}
