...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-emailTemplate-grid.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_emailtemplate} / <strong>{$smarty.config.Home}</strong></h5>
                            </div>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="jqGrid_wrapper">
                                    <input type="hidden" name="_token" id= "_token" value="{$token}">
                                    <table id="table_list_emailTemplate"></table>
                                    <div id="pager_list_emailTemplate"></div>
                                </div>
