...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-reportgroup.js"}
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_reports} / <strong>{$smarty.config.pgr_reportgroup}</strong></h4>
                </div>
            </div>
            ...
            <form method="get" class="form-horizontal" id="inv-report-form" name="inv-report-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <!-- Combo Grupo -->
                    <div id = "campoRelGroup" class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{$smarty.config.Select_group}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbGroup" id="cmbGroup" >
                                    <option value="" disabled hidden selected>{$smarty.config.Select}</option>
                                    <option value="ALL">{$smarty.config.all}</option>
                                    {html_options values=$GroupIds output=$GroupVals selected=$idgroup}
                                </select>
                            </div>
                        </div>
                    </div>  
