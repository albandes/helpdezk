        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content  ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_lgp_data_mapping} / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
                </div>
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="add-data-map-form">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox i-checks"><label> <input type="checkbox" name="datashared" id="datashared" value="S"> <i></i> &nbsp;{$smarty.config.Yes}</label></div>
                            </div>


                            <div id="sharedWithLine" class="form-group hide">
                    ...
                    <div class="row wrapper  white-bg ">
                        <div class="col-sm-12 b-l">
                            <div id="alert-add-data-mapping"></div>
                        </div>
                    </div>
                    ...
                    <div class="row wrapper  white-bg text-center">
                        <div class="col-sm-12 form-group">
                            ...
                            <button type="button" class="btn btn-primary btn-md " id="btnCreateDataMap" >
