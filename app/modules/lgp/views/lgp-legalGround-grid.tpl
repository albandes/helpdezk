...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-legalGround-grid.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_legalground} / <strong>{$smarty.config.Home}</strong></h5>

                            </div>

                            <div class="ibox-content">

                                <button id="btnCreate" type="button" class="btn btn-primary btn-xs {$display_btn_add}">
									<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;{$smarty.config.New}</button>
                                <button id="btnUpdate" type="button" class="btn btn-primary btn-xs {$display_btn_edit}">
									<i class="fa fa-edit" aria-hidden="true"></i>&nbsp;{$smarty.config.edit}</button>
                                <button id="btnEcho"   type="button" class="btn btn-primary btn-xs">
									<i class="fa fa-eye" aria-hidden="true"></i>&nbsp;{$smarty.config.Grid_view}</button>
                                <button id="btnDisable"type="button" class="btn btn-primary btn-xs disabled">
									<i class="fa fa-lock" aria-hidden="true"></i>&nbsp;{$smarty.config.Deactivate}</button>
                                <button id="btnEnable" type="button" class="btn btn-primary btn-xs disabled">
									<i class="fa fa-unlock" aria-hidden="true"></i>&nbsp;{$smarty.config.Activate}</button>

                                <p></p>

                                <div class="jqGrid_wrapper">
                                    <table id="table_list_legalGround"></table>
                                    <div id="pager_list_legalGround"></div>
                                </div>
