...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-emailTemplate-create.js"}
    <!-- Font Awesome -->
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            <div class="row wrapper    white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_erp_emailtemplate} / <strong>{$smarty.config.edit}</strong></h4>
                </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-emailtemplate-form">

                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="emailTemplateID" id= "emailTemplateID" value="{$hidden_idtemplate}">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="emailTemplateName" name="emailTemplateName" class="form-control input-sm" value="{$emailTemplateName}" >
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div id="alert-emailtemplate-update"></div>
                    </div>
                    ...
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <button type="button" class="btn btn-primary btn-md" id="btnUpdate">
