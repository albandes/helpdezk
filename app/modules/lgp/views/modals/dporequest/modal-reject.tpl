        ...
        <div class="modal-dialog modal-sm"  role="document" >
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" id="btnCancelRejectTicket" data-dismiss="modal"><i class='fa fa-times-circle'></i>  {$smarty.config.Close}</button>
                    <button type="submit" class="btn btn-primary" id="btnSaveRejectTicket"><i class='fa fa-ban'></i>  {$smarty.config.Reject_btn}</button>
                </div>
