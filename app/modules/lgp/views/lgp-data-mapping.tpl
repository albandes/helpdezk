...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="datamapping.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_lgp_data_mapping} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <div class="ibox-content">
                                ...
                                <button id="btnView" type="button" class="btn btn-primary btn-xs"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;{$smarty.config.TMS_Visualiza}</button>                                <p></p>

                                <div class="jqGrid_wrapper">
                                    <table id="table_list_datamapping"></table>
                                    <div id="pager_list_datamapping"></div>
                                </div>
