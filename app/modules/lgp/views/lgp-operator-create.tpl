        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.records} / {$smarty.config.pgr_operator} / <strong>{$smarty.config.Add}</strong></h4>
                    </div>
                </div>
                ...
                <!-- Form area -->
                <form method="get" class="form-horizontal" id="create-operator-form">
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-10 b-l row wrapper white-bg">
                            <div class="form-group">
                                <label class="col-sm-2 control-label">{$smarty.config.Category}:</label>
                                <div class="col-sm-5">
                                    <label class="radio-inline i-checks"> 
                                        <input type="radio" name="categoryOperator" id="2" value="2">&nbsp;&nbsp;{$smarty.config.juridical}
                                    </label>
                                    <label class="radio-inline i-checks"> 
                                        <input type="radio" name="categoryOperator" id="1" value="1">&nbsp;&nbsp;{$smarty.config.natural}
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row wrapper white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div class="form-group commonView hide ">
                                ...
                                <div class="col-sm-7 ">
                                    <input type="text " id="operatorName" name="operatorName" class="form-control input-sm" placeholder="{$plh_controller_description} " value="" >
                                </div>
                            </div>         
                        </div>
                    </div>      
                    ...
                    <div class="row wrapper white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div class="form-group commonView hide ">
                                ...
                                <div class="col-sm-3 ">
                                    <input type="text " id="operatorPhone" name="operatorPhone" class="form-control input-sm " placeholder="{$plh_program_description} " value="" >
                                </div>                            
                                <label class="col-sm-1 control-label">{$smarty.config.Mobile_phone}:</label>
                                <div class="col-sm-3">
                                    <input type="text " id="operatorMobile" name="operatorMobile" class="form-control input-sm " placeholder="{$plh_program_description} " value="" >
                                </div>                            
                            </div>
                        </div>
                    </div>
                    <div class="row wrapper white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div class="form-group juridicalView hide ">
                                ...
                                <div class="col-sm-7 ">
                                    <input type="text " id="operatorContact" name="operatorContact" class="form-control input-sm " placeholder="{$plh_controller_description} " value="" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row wrapper  white-bg ">
                            <div class="col-sm-12 b-l">
                                <div id="alert-operator-create"></div>
                            </div>
                        </div>
                        <div class="row wrapper  border-bottom white-bg ">&nbsp;</div>
                        <div class="col-xs-12 white-bg" style="height:10px;"></div>
