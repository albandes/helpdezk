...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-operator-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_operator}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-operator-form">
                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="operatorID" id= "operatorID" value="{$hidden_idperson}">
                <input type="hidden" name="categoryOperator" id= "categoryOperator" value="{$idnatureperson}">
				...
				<div class="row wrapper white-bg ">
					...
					<div class="col-sm-11 b-l">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" id="operatorName" name="operatorName" class="form-control input-sm" value="{$operatorName}">
							</div>
						</div>
					</div>
				</div>
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" id="operatorPhone" name="operatorPhone" class="form-control input-sm" value="{$operatorPhone}" >
                            </div>                    
                            <label class="col-sm-1 control-label">{$smarty.config.Mobile_phone}:</label>
                            <div class="col-sm-3">
                                <input type="text" id="operatorMobile" name="operatorMobile" class="form-control input-sm" value="{$operatorMobile}" >
                            </div>                    
                        </div>
                    </div>
                </div>
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group {$displayJuridical} ">
                            <label class="col-sm-2 control-label {$displayJuridical}">{$smarty.config.Contact_person}:</label>
                            <div class="col-sm-7">
                                <input type="text" id="operatorContact" name="operatorContact" class="form-control input-sm {$displayJuridical}" placeholder="{$plh_controller_description}" value="{$operatorContact}" >
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row wrapper  white-bg ">
                    <div class="col-sm-12 b-l">
                        <div id="alert-operator-update"></div>
                    </div>
                </div>
                ...
                <div class="row wrapper  white-bg text-center">
                    <div class="col-sm-12 b-l">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <a href="" id="btnCancel" class="btn btn-white btn-md" role="button">
								<i class="fa fa-arrow-alt-circle-left" aria-hidden="true"></i> {$smarty.config.Back_btn} </a>
