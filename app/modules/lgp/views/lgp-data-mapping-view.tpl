        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content  ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_lgp_data_mapping} / <strong>{$smarty.config.TMS_Visualiza}</strong></h4>
                    </div>
                </div>
                    ...
                    <div class="row wrapper  white-bg ">
                        ...
                        <div class="col-sm-11 b-l">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtHolderType}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$descricao}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtType}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtPurpose}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtFormat}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtCollectForm}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtLegalGround}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtStorage}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtWhoAccesses}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$ischecked}
                                </div>
                            </div>
                            ...
                            <div id="sharedWithLine" class="form-group {$flgdisplay}">
                                ...
                                <div class="col-sm-5">
                                    <p class="form-control-static">{$txtWith}
                                </div>
                            </div>
                        </div>
                    </div>
