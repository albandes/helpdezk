...
$(document).ready(function () {
     ...
     * Buttons
     */
    $("#btnCancel").attr("href", path + '/lgp/lgpClassification/index');
    ...
    $("#btnSave").click(function(){
        ...
        if(!$("#btnSave").hasClass('disabled')){
            $.ajax({
                type: "POST",
                url: path + '/lgp/lgpClassification/createClassification',
                dataType: 'json',
                ...
                success: function(ret){
                    ...
                    if(obj.success) {
                        showAlert(makeSmartyLabel('Alert_inserted'),'success',path + '/lgp/lgpClassification/index');                        
                    } else {
                        modalAlertMultiple('danger',makeSmartyLabel('Alert_failure'),'alert-classification-create');
                    }
                },
    ...
    $("#btnSaveUpdate").click(function(){
        ...
        if(!$("#btnSaveUpdate").hasClass('disabled')){
            $.ajax({
                type: "POST",
                url: path + '/lgp/lgpClassification/updateClassification',
                dataType: 'json',
                ...
                success: function(ret){
                    ...
                    if(obj.success) {
                        showAlert(makeSmartyLabel('Edit_sucess'),'success',path + '/lgp/lgpClassification/index');
                    } else {
                        modalAlertMultiple('danger',makeSmartyLabel('Edit_failure'),'alert-classification-update');
                    }
                },
    ...
    $("#create-classification-form").validate({
        ...
        rules: {
            classificationName:  {
                required:true,
                remote:{
                    url: path+"/lgp/lgpClassification/existClassification",
                    type: 'post',
                    dataType:'json',
                    async: false,
                }
        ...
        messages: {
            classificationName: {required:makeSmartyLabel('Alert_field_required')}
        }
    });
