...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-report.js"}
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content">
            <div class="row wrapper white-bg ibox-title">
                <div class="col-sm-4">
                    <h4>{$smarty.config.cat_reports} / <strong>{$smarty.config.pgr_lgpreport}</strong></h4>
                </div>
            </div>
            ...
            <form method="get" class="form-horizontal" id="inv-report-form" name="inv-report-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div id = "campoRelType" class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{$smarty.config.lgp_type}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbType" id="cmbType" >
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <!-- Campo Tipo Titular -->
                    <div id = "fieldClassification" class="col-sm-11 b-l ">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{$smarty.config.lgp_holdertype}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbHoldertype" id="cmbHoldertype" >
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <!-- Campo Tipo de dado -->
                    <div id = "fieldDataType" class="col-sm-11 b-l ">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{$smarty.config.lgp_datatype}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbDatatype" id="cmbDatatype" >
                                    <option value="ALL">{$smarty.config.all}</option>
                                    {html_options values=$DatatypeIds output=$DatatypeVals selected=$iddatatype}
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper  white-bg">
                    ...
                    <!-- Campo Armazenamento -->
                    <div  id = "fieldStorage" class="col-sm-11 b-1">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{$smarty.config.lgp_storage}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbStorage" id="cmbStorage" >
                                    <option value="ALL">{$smarty.config.all}</option>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <!-- Campo Quem acessa -->
                    <div id = "fieldWhoAccess" class="col-sm-11 b-l relDep">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{$smarty.config.lgp_whoaccess}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbWhoaccess" id="cmbWhoaccess">
                                    <option value="ALL">{$smarty.config.all}</option>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <!-- Campo Compartilhado com quem -->
                    <div id = "fieldSharedWhom" class="col-sm-11 b-l relDep hide">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">{$smarty.config.lgp_sharedwhom}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbSharedWhom" id="cmbSharedWhom">
                                    <option value="ALL">{$smarty.config.all}</option>
                                    {html_options values=$PersonsharedIds output=$PersonsharedVals selected=$idpersonshared}
                                </select>
                            </div>
                        </div>
                    </div>
