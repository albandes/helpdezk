...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-type-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_type}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-type-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="tipoID" id= "tipoID" value="{$hidden_idtipodado}">
				...
				<div class="row wrapper white-bg ">
					...
					<div class="col-sm-11 b-l">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" id="tipoName" name="tipoName" class="form-control input-sm" value="{$tipoName}">
							</div>
						</div>
					</div>
				</div>
                ...
                <div class="col-sm-11 b-l">
                    <div class="form-group">
                        ...
                        <div class="checkbox i-checks">
							<label> 
								<input type="checkbox" id="tipoDefault" name="tipoDefault" value="S" {$isdefault}> <i></i> 
								&nbsp;{$smarty.config.Yes}
							</label>
						</div>
                    </div>
