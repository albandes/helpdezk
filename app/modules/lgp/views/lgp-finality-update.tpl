...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-finality-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_finality}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="update-finality-form">

                <!-- Hidden -->
                <input type="hidden" name="_token" id= "_token" value="{$token}">
                <input type="hidden" name="finalityID" id= "finalityID" value="{$hidden_idfinalidade}">
				...
				<div class="row wrapper white-bg ">
					...
					<div class="col-sm-11 b-l">
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" id="finalityName" name="finalityName" class="form-control input-sm" value="{$finalityName}">
							</div>
						</div>
					</div>
				</div>
