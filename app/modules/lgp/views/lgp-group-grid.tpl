...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-group-grid.js"}
...
<body class="top-navigation">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_lgpgroup} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <input type="hidden" name="_token" id= "_token" value="{$token}">
                                ...
                                <button id="btnPeopleGroup" type="button" class="btn btn-primary btn-xs"><i class="fa fa-headset" aria-hidden="true"></i>&nbsp;{$smarty.config.People_by_group}</button>
                                <p></p>

                                <div class="jqGrid_wrapper">
                                    <table id="table_list_lgpgroup"></table>
                                    <div id="pager_list_lgpgroup"></div>
                                </div>
    ...
    {include file='modals/main/modal-alert.tpl'}
     {include file='modals/lgpgroup/modal-people-group.tpl'}
