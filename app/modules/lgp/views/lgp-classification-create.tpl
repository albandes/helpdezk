                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="classificationName" name="classificationName" class="form-control input-sm" >
                            </div>
                        </div>
                    </div>
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="checkbox i-checks"><label> <input type="checkbox" id="classificationDefault" name="classificationDefault" value="S" > <i></i> &nbsp;{$smarty.config.Yes}</label></div>
                        </div>
                    </div>
