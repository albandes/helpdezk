...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="wrapper wrapper-content  ">
            ...
            <!-- Form area -->
            <form method="get" class="form-horizontal" id="create-emailtemplate-form">
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="emailTemplateName" name="emailTemplateName" class="form-control input-sm" value="" >
                            </div>
                        </div>
                ...
                <div class="row wrapper  white-bg ">
                    ...
                    <div class="col-sm-10 b-l">
                        <div id="alert-emailtemplate-create"></div>
                    </div>
