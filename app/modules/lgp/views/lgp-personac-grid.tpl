...
<head>
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgp-personac-grid.js"}
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            ...
                            <div class="ibox-title">
                                <h5>{$smarty.config.cat_records} / {$smarty.config.pgr_lgppersonac} / <strong>{$smarty.config.Home}</strong></h5>
                            ...
                            <input type="hidden" name="_token" id= "_token" value="{$token}">
                                ...
                                <div class="jqGrid_wrapper">
                                    <table id="table_list_lgppersonac"></table>
                                    <div id="pager_list_lgppersonac"></div>
                                </div>
