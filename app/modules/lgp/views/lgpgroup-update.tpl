...
<head>
    ...
    *}
    ...
    {head_item type="js" src="$path/app/modules/lgp/views/js/" files="lgpgroup-create.js"}
    <!-- Font Awesome -->
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="wrapper wrapper-content ">
                <div class="row wrapper white-bg ibox-title">
                    <div class="col-sm-4">
                        <h4>{$smarty.config.cat_records} / {$smarty.config.pgr_lgpgroup}  / <strong>{$smarty.config.edit}</strong></h4>
                    </div>
            ...
            <form method="get" class="form-horizontal" id="update-group-form">
                ...
                <input type="hidden" name="groupID" id= "groupID" value="{$hidden_groupID}">
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">{$smarty.config.hdk_company}:</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm" name="cmbGroupCompany" id="cmbGroupCompany" >
                ...
                <div class="row wrapper white-bg ">
                    ...
                    <div class="col-sm-11 b-l">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" id="groupName" name="groupName" class="form-control input-sm" value = "{$groupName}" placeholder="{$plh_nome}" >
                            </div>
                        </div>
                    </div>
