...
define ('BACK',				'Volta');
define ('NEXT',				'Pr&oacute;ximo');
define ('ENABLE',			'Dispon&iacute;vel');
define ('DISABLE',			'Indisispon&iacute;vel');
define ('OK',				'SUCESSO');
define ('NOT_OK',			'FALHA');
define ('REQUIRED_FIELD' ,  'Preenchimento obrigatório');

define ('PROGRESS_STEP_1', 	'Etapa 1 de 7 - Selecione o idioma.');
define ('INFO_STEP_1',     	'Para começar, selecione o idioma preferido e clique em "Pr&oacute;ximo".');
...
define ('DB_CONFIGURE',		'Configurações do servidor do banco de dados');
...
define ('WAIT_INSTALL',    	'Serão criadas as tabelas do banco de dados, as procedures e views. Aguarde enquanto a instalação é realizada. Isto pode demorar alguns minutos ...');
