...
<div id=content class="col-md-12">
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title"> <h5><?php echo PROGRESS_STEP_3 ?></h5> </div>
                    ...
                    <div class="feed-element">
                        <div class="media-body ">
                            <form method="get" class="form-horizontal">
                                <div class="col-lg-12">
                                    <h5><?php echo INFO_STEP_3 ?></h5>
                                </div>

                                <div class="form-group">&nbsp;</div>

                                <div class="col-lg-12">
                                    <?php echo WEB_URL_THEME ?>
                                    <div class="hr-line-dashed"></div>
                                </div>


                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo HDK_URL ?></label>
                                    <div class="col-sm-9"><input type="text" id="site_url" name="site_url" class="form-control" value="<?php echo $pageURL ?>" ></div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo LANGUAGE ?></label>
                                    <div class="col-sm-6">
                                        <select id="language_default" class="form-control m-b" name="language_default">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"><?php echo TIMEZONE ?></label>
                                    <div class="col-sm-6">
                                        <select id="timezone_default" class="form-control m-b" name="timezone_default">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-primary btn-sm" onclick="step_2('<?php echo $_POST['i18n'] ?>')">
                                        <i class="fa fa-arrow-left"></i>&nbsp;<?php echo BACK ?></button>
                                </div>
                                <div class="col-md-3">
                                    <button class="btn btn-primary btn-sm" type="button" id="button_step_4" onclick="step_4('<?php echo $_POST['i18n'] ?>')">
