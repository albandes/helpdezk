...
$pageURL = curPageURL(); 
$pageURL = substr($pageURL, 0, strpos($pageURL, $install_dir)   );
...
?>
	...
	<div class="progress">
		<?php echo PROGRESS_STEP_3 ?>		
	</div>
						
	<div class="sections">
		<div class="info">
			<?php echo utf8_encode(INFO_STEP_3) ?>
		</div>
	
		<div class="row">
			<h2><?php echo utf8_encode(WEB_URL_THEME) ?></h2>
			<label for="field_site_url" ><?php echo utf8_encode(HDK_URL) ?></label>
			<div class="field">
				<input type="text" id="field_site_url" name="site_url" value="<?php echo $pageURL ?>"  class="text xlarge" readonly="readonly"/>
			</div>
		</div>
		
						<div class="row">
							<label for="field_language_default" >
								<?php echo utf8_encode(LANGUAGE) ?>																			
							</label>
							<div class="field">
						...
						<div class="row">
							<label for="field_timezone_default" >
								<?php echo utf8_encode(TIMEZONE) ?>																			
							</label>
							<div class="field">
								<select id="field_language_default" name="timezone_default"  class="select">
                                                                    ...
                                                                    <option value = "Africa/Lusaka">AfricaLusaka</option>
                                                                    ...
                                                                    <option value = "Africa/Ouagadougou"> AfricaOuagadougou</option>
                                                                    ...
                                                                    <option value = "Africa/Bissau"> Africav</option>
                                                                    ...
                                                                    <option value = "America/Argentina/Cordoba"> America ArgentinaCordoba</option>
                                                                    ...
                                                                    <option value = "America/Dawson_Creek"> AmericaDawson_Creek</option>
                                                                    ...
                                                                    <option value = "America/Indiana/Vincennes"> AmericaIndiana/Vincennes</option>
                                                                    ...
                                                                    <option value = "America/Puerto_Rico"> America Adak</option>
                                                                    ...
                                                                    <option value = "America/Yellowknife"> AmericaYellowknife</option>
                                                                    ...
                                                                    <option value = "Europe/Chisinau"> Europe Ams</option>
                                                                    ...
                                                                    <option value = "Pacific/Rarotonga">PacificRarotonga</option>
						...
						<div class="row">
							<label for="field_theme_default" >
								<?php echo utf8_encode(THEME) ?>																			
							</label>
							<div class="field">
								<select id="field_theme_default" name="theme_default"  class="select">
		...
		<div class="buttons">
			<button class="button button-back" onclick="step_2('<?php echo $_POST['i18n'] ?>')" ><?php echo BACK ?></button>
			<button class="button button-next" onclick="step_4('<?php echo $_POST['i18n'] ?>')" ><?php echo NEXT ?></button>
		</div>
